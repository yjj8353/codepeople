...
demo = {
    ...
    initChartist: function(){
    	...
    	$.ajax({
    		url:'acknowledge/ajax/sevendays.do',
    		method:'POST',
			data:{
				'functionName':'visitorCountListSevenDays'
			},
			success:function(result) {
				visitorCounts = result
			},
			error:function() {
				console.log('에러');
			}
        ...
        var dataSales = {
          ...
          series: [[visitorCounts[0], visitorCounts[1], visitorCounts[2], visitorCounts[3], visitorCounts[4], visitorCounts[5], visitorCounts[6], visitorCounts[7]]]
        };
